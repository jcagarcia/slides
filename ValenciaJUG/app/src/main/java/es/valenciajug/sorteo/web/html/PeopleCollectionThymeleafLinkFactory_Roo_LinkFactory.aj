...
import es.valenciajug.sorteo.web.html.PeopleCollectionThymeleafLinkFactory;
...
privileged aspect PeopleCollectionThymeleafLinkFactory_Roo_LinkFactory {
     ...
     * 
     */
    public static final String PeopleCollectionThymeleafLinkFactory.DATATABLESBYIDSIN = "datatablesByIdsIn";
